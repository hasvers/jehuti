...
class BasicUI(UI_Widget):
    ...
    def confirm_menu(self,output_method,**kwargs):
        ...
        window.add('text',val=kwargs.pop('legend','Are you sure?'),
            selectable=False,colspan=2,maxlines=None)
        window.add('text',val='Ok',output_method=output_method,selectable=True,
            pos=(1,0))
        window.add('text',val='Cancel',output_method='exit',selectable=True,
            pos=(1,1))
        self.float_core(window,'floatdialog',**kwargs)
